...
if (function_exists('acf_add_options_page')) {
	acf_add_options_sub_page(array(
		'page_title'     => 'Stestlive Page',
		'menu_title'    => 'Stestlive Page',
		'parent_slug'    => 'edit.php?post_type=stestlive',
	));
}
if (function_exists('acf_add_options_page')) {
	acf_add_options_sub_page(array(
...
if (function_exists('acf_add_options_page')) {
	acf_add_options_sub_page(array(
		'page_title'     => 'Finaltest Page',
		'menu_title'    => 'Finaltest	 Page',
		'parent_slug'    => 'edit.php?post_type=finaltest',
	));
}
if(function_exists('acf_add_options_page')) {
	acf_add_options_sub_page(array(
...
// Stestlive Custom Post type
function stestlive_int()
{
	// set up service labels
	$labels = array(
		'name' => 'Stestlive',
		'singular_name' => 'Stestlive',
		'add_new' => 'Add New Stestlive',
		'add_new_item' => 'Add New Stestlive',
		'edit_item' => 'Edit Stestlive',
		'new_item' => 'New Stestlive',
		'all_items' => 'All Stestlive',
		'view_item' => 'View Stestlive',
		'search_items' => 'Search Stestlive',
		'not_found' =>  'No Stestlive Found',
		'not_found_in_trash' => 'No Stestlive found in Trash',
		'parent_item_colon' => '',
		'menu_name' => 'Stestlive',
	);
	// register post type
	$args = array(
		...
		"publicly_queryable" => true,
		"hierarchical" => false,
		'rewrite' => array('slug' => 'stestlive', 'with_front' => false),
		'query_var' => true,
		'show_in_nav_menus' => true,
		'show_ui' => true,
		'menu_icon' => 'dashicons-tickets',
	...
	flush_rewrite_rules();
	register_post_type('stestlive', $args);
	// register taxonomy
	register_taxonomy(
		'stestlive-category',
		'stestlive',
		array(
			'hierarchical' => true,
			'label'        => 'Stestlive Category',
			'query_var'    => true,
			'rewrite'      => array(
				'slug'       => 'stestlive-category',
				'with_front' => false,
			),
		)
	);
...
add_action('init', 'stestlive_int');
add_action('wp_ajax_nopriv_get_stestlive_from_api', 'get_stestlive_from_api');
add_action('wp_ajax_get_stestlive_from_api', 'get_stestlive_from_api');
function get_stestlive_from_api(){
	$file = get_stylesheet_directory() . '/report.txt';
	$current_page = ( ! empty($_POST['current_page'])) ? $_POST['current_page'] : 1;
	$stestlive = [];

	$results = wp_remote_retrieve_body( wp_remote_get('https://academics.cmcvellore.edu.in/api/collegeWebsite/getAllDepartment/page='
	...
	$stestlive[] = $results;
	foreach( $stestlive[0] as $Stestlive ){

	}
	$current_page = $current_page + 1;
	wp_remote_post( admin_url('admin-ajax.php?action=get_stestlive_from_api'), [
		'blocking' => false,
		'sslverify' => false,
		'body' => [
...
// Final test page
function finaltest_int()
{
	// set up service labels
	$labels = array(
		'name' => 'Finaltest',
		'singular_name' => 'Finaltest',
		'add_new' => 'Add New Finaltest',
		'add_new_item' => 'Add New Finaltest',
		'edit_item' => 'Edit Finaltest',
		'new_item' => 'New Finaltest',
		'all_items' => 'All Finaltest',
		'view_item' => 'View Finaltest',
		'search_items' => 'Search Finaltest',
		'not_found' =>  'No Finaltest Found',
		'not_found_in_trash' => 'No Finaltest found in Trash',
		'parent_item_colon' => '',
		'menu_name' => 'Finaltest',
	);
	// register post type
	$args = array(
		...
		"publicly_queryable" => true,
		"hierarchical" => false,
		'rewrite' => array('slug' => 'finaltest', 'with_front' => false),
		'query_var' => true,
		'show_in_nav_menus' => true,
		'show_ui' => true,
		'menu_icon' => 'dashicons-groups',
	...
	flush_rewrite_rules();
	register_post_type('finaltest', $args);
	// register taxonomy
	register_taxonomy(
		'finaltest-category',
		'finaltest',
		array(
			'hierarchical' => true,
			'label'        => 'Finaltest Category',
			'query_var'    => true,
			'rewrite'      => array(
				'slug'       => 'finaltest-category',
				'with_front' => false,
			),
		)
	);
...
add_action('init', 'finaltest_int');
// department name change
function department_int()
{
        // set up service labels
        $labels = array(
                'name' => 'Department',
...
add_action('init', 'department_int');
// department name change end
...
//faculties
function faculties_int()
{
        // set up service labels
        $labels = array(
                'name' => 'Faculties',
                'singular_name' => 'Faculties',
                'add_new' => 'Add New Faculties',
                'add_new_item' => 'Add New Faculties',
                'edit_item' => 'Edit Faculties',
                'new_item' => 'New Faculties',
        ...
        $args = array(
                ...
                "publicly_queryable" => true,
                "hierarchical" => false,
                'rewrite' => array('slug' => 'faculties', 'with_front' => false),
                'query_var' => true,
                'show_in_nav_menus' => true,
                'show_ui' => true,
                'menu_icon' => 'dashicons-groups',
     ...
     register_post_type('faculties', $args);
        ...
        register_taxonomy(
                ...
                array(
                        'hierarchical' => true,
                        'label'        => 'Faculties Category',
                        'query_var'    => true,
                        'rewrite'      => array(
                                'slug'       => 'faculties-category',
                                'with_front' => false,
                        ),
                )
        );
